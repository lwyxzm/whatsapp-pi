...
const fallback = {
    ...
    "incoming.media.reactionWithContext": "{emoji} Reacted to: \"{originalText}\"",
    "incoming.media.reactionRemovedWithContext": "Removed reaction from: \"{originalText}\"",
    "incoming.quoted.image": "[Image]",
    "incoming.quoted.video": "[Video]",
    "incoming.quoted.audio": "[Audio]",
    "incoming.quoted.document": "[Document]",
    "incoming.quoted.contact": "[Contact]",
    "incoming.quoted.location": "[Location]",
    "incoming.quoted.locationWithCoords": "[Location: {lat}, {lng}]",
    "incoming.quoted.locationWithName": "[Location: {name} ({lat}, {lng})]",
    "incoming.quoted.message": "[Message]",
    "incoming.quoted.replyingTo": "↩️ Replying to: \"{quotedText}\"",
    "incoming.location.coordinates": "📍 Location: {lat}, {lng}",
    "incoming.location.name": "Name: {name}",
    "incoming.location.address": "Address: {address}",
    "incoming.location.googleMapsLink": "Google Maps: https://www.google.com/maps?q={lat},{lng}",
    "incoming.contact.withName": "👤 Contact: {name}",
    "incoming.contact.phone": "Phone: {phone}",
    "incoming.contact.additionalPhone": "Additional: {phone}",
    "incoming.contact.multiple": "👥 {count} Contacts",
    "incoming.contact.multipleHeader": "👥 {count} Contacts:",
    "incoming.contact.unnamed": "Unnamed Contact",
    "incoming.quoted.contactWithName": "[Contact: {name}]",
    "incoming.quoted.multipleContacts": "[{count} Contacts]",
...
const translations: Record<Locale, Partial<Record<Key, string>>> = {
    "pt-BR": {
        ...
        "incoming.media.reactionWithContext": "{emoji} Reagiu a: \"{originalText}\"",
        "incoming.media.reactionRemovedWithContext": "Removeu reação de: \"{originalText}\"",
        "incoming.quoted.image": "[Imagem]",
        "incoming.quoted.video": "[Vídeo]",
        "incoming.quoted.audio": "[Áudio]",
        "incoming.quoted.document": "[Documento]",
        "incoming.quoted.contact": "[Contato]",
        "incoming.quoted.location": "[Localização]",
        "incoming.quoted.locationWithCoords": "[Localização: {lat}, {lng}]",
        "incoming.quoted.locationWithName": "[Localização: {name} ({lat}, {lng})]",
        "incoming.quoted.message": "[Mensagem]",
        "incoming.quoted.replyingTo": "↩️ Respondendo a: \"{quotedText}\"",
        "incoming.location.coordinates": "📍 Localização: {lat}, {lng}",
        "incoming.location.name": "Nome: {name}",
        "incoming.location.address": "Endereço: {address}",
        "incoming.location.googleMapsLink": "Google Maps: https://www.google.com/maps?q={lat},{lng}",
        "incoming.contact.withName": "👤 Contato: {name}",
        "incoming.contact.phone": "Telefone: {phone}",
        "incoming.contact.additionalPhone": "Adicional: {phone}",
        "incoming.contact.multiple": "👥 {count} Contatos",
        "incoming.contact.multipleHeader": "👥 {count} Contatos:",
        "incoming.contact.unnamed": "Contato sem nome",
        "incoming.quoted.contactWithName": "[Contato: {name}]",
        "incoming.quoted.multipleContacts": "[{count} Contatos]",
    ...
    es: {
        ...
        "incoming.media.reactionWithContext": "{emoji} Reaccionó a: \"{originalText}\"",
        "incoming.media.reactionRemovedWithContext": "Eliminó reacción de: \"{originalText}\"",
        "incoming.quoted.image": "[Imagen]",
        "incoming.quoted.video": "[Video]",
        "incoming.quoted.audio": "[Audio]",
        "incoming.quoted.document": "[Documento]",
        "incoming.quoted.contact": "[Contacto]",
        "incoming.quoted.location": "[Ubicación]",
        "incoming.quoted.locationWithCoords": "[Ubicación: {lat}, {lng}]",
        "incoming.quoted.locationWithName": "[Ubicación: {name} ({lat}, {lng})]",
        "incoming.quoted.message": "[Mensaje]",
        "incoming.quoted.replyingTo": "↩️ Respondiendo a: \"{quotedText}\"",
        "incoming.location.coordinates": "📍 Ubicación: {lat}, {lng}",
        "incoming.location.name": "Nombre: {name}",
        "incoming.location.address": "Dirección: {address}",
        "incoming.location.googleMapsLink": "Google Maps: https://www.google.com/maps?q={lat},{lng}",
        "incoming.contact.withName": "👤 Contacto: {name}",
        "incoming.contact.phone": "Teléfono: {phone}",
        "incoming.contact.additionalPhone": "Adicional: {phone}",
        "incoming.contact.multiple": "👥 {count} Contactos",
        "incoming.contact.multipleHeader": "👥 {count} Contactos:",
        "incoming.contact.unnamed": "Contacto sin nombre",
        "incoming.quoted.contactWithName": "[Contacto: {name}]",
        "incoming.quoted.multipleContacts": "[{count} Contactos]",
